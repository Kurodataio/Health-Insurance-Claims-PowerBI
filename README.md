# Health-Insurance-Claims-PowerBI
Health Insurance Claims Analysis with Power BI v2, analyzing demographic and behavioural risk factors (Age, BMI, Smoking status) impacting medical insurance charges.
...
## Overview
- The dataset was chosen to assess health insurance claims using Power BI
...
git clone https://github.com/Kurodataio/Health-Insurance-Claims-PowerBI.git

# Navigate to the project folder
cd Health-Insurance-Claims-PowerBI
...
1. Open the Power BI file (`Medical Cost Personal.pbix`)  
...
![PowerBI-Medical_Claims_Dashboard_preview](PowerBI-Medical_Claims_Dashboard_preview.png)

- **Insurance Claims Dashboard Preview - Southeast Region**
![PowerBI-Medical_claims-Dashboard-SouthEast](PowerBI-Medical_claims-Dashboard-SouthEast.png)
